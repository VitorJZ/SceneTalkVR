...
namespace SceneTalkVR.Runtime
{
    ...
    public sealed class PilotCollectionParticipantUi : MonoBehaviour
    {
        ...
        private static string Friendly(PilotEmbodimentCondition value)=>value==PilotEmbodimentCondition.VoiceOnly?"仅语音反馈":value==PilotEmbodimentCondition.FloatingOrb?"悬浮球反馈":"人形辅助角色反馈";
        private static string Humanize(string error)=>SceneTalkChineseUiText.Error(error);
