    ...
    public static class PilotPresentationCatalogBuilder
    {
        ...
        public static void Build()
        {
            ...
            asset.EditorSet("1.2-editor-collection",new[]{
                ...
                new PilotPresentationProfile{embodimentCondition=PilotEmbodimentCondition.FloatingOrb,visualMode=PilotVisualMode.FloatingOrb,feedbackActor="floating_orb_feedback_agent",voiceProfileKey=voice,audioSourcePolicy=PilotAudioSourcePolicy.SpatialFixedSource,sourcePosition=new Vector3(.9f,1.45f,1.8f),spatialBlend=1,minDistance=3.2f,maxDistance=8,volume=1,speakingSpeed=1,subtitlePolicy="feedback_only",visualPrefabKey="generated_orb_v1",appearanceDelayMs=0,disappearanceDelayMs=0,audioSourceRequired=true,mobileReady=true,assetVersion="editor-collection-1",approvedForCollection=true,evidenceReference="formal-editor-collection-directive-v1"},
                new PilotPresentationProfile{embodimentCondition=PilotEmbodimentCondition.HumanoidAgent,visualMode=PilotVisualMode.Humanoid,feedbackActor="humanoid_feedback_agent",voiceProfileKey=voice,audioSourcePolicy=PilotAudioSourcePolicy.SpatialFixedSource,sourcePosition=new Vector3(.9f,0,1.8f),spatialBlend=1,minDistance=3.2f,maxDistance=8,volume=1,speakingSpeed=1,subtitlePolicy="feedback_only",visualPrefabKey="correction_assistant_woman",visualPrefab=humanoid,animatorController=animator,idleParameterOrState="Idle",speakingParameterOrState="Talking",spawnRotation=new Vector3(0,180,0),scale=Vector3.one,audioSourceRequired=true,mobileReady=true,assetVersion="editor-collection-1",approvedForCollection=true,evidenceReference="formal-editor-collection-directive-v1"}
