...
namespace SceneTalkVR.Core
{
    ...
    {
        [SerializeField] private string protocolVersion = "1.1-rehearsal-1";
        ...
        [SerializeField] private string evidenceReference = "scenetalkvr-rehearsal-baseline-v1";
        [SerializeField] private string protocolSnapshotId = "v1.1-rehearsal-1-protocol";
        ...
        public int FormalMaxTurns => 6; public float FormalMaxDurationMinutes => 10f; public int PilotMaxTurns => 5; public float PilotMaxDurationMinutes => 8f;
