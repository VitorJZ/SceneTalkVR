...
namespace SceneTalkVR.Tests.Editor
{
    public sealed class EditorCollectionFormalFlowTests
    {
        ...
        [TestCase("hotel_check_in", "quiet_room", "Could I have a quiet room away from the elevator?")]
        [TestCase("hotel_check_in", "wifi_access", "Does the hotel have Wi-Fi?")]
        ...
        [TestCase("furniture_shopping", "color_preference", "What colors are available?")]
        [TestCase("furniture_shopping", "delivery", "Do you offer home delivery?")]
        [TestCase("furniture_shopping", "assembly_service", "Is assembly service included?")]
        ...
        [TestCase("gym_membership", "opening_hours", "What are your opening hours?")]
        [TestCase("gym_membership", "monthly_price", "How much is the membership per month?")]
        [TestCase("gym_membership", "student_discount", "Do you offer a student discount?")]
        ...
        [TestCase("tourist_assistance", "museum_hours", "What are the museum opening hours?")]
        [TestCase("tourist_assistance", "ticket", "Do I need a ticket?")]
        [TestCase("tourist_assistance", "photography", "Can I take photos inside?")]
        [TestCase("tourist_assistance", "visit_duration", "How long does it take to visit the museum?")]
